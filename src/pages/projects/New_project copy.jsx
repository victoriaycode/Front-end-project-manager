            ...
            <li className="text-gray-500 font-semibold text-lg font-light mt-2">
                ...
                <div className="w-full flex flex-row mt-5 px-2 text-gray-600">
                    ...
                    {editRow ? (<>
                        ...
                        <input type="text" name="descripcion" className="h-10 w-5/6 mx-5 px-10 mt-1 rounded-2xl z-0 focus:outline-none bg-gray-50 border-2 border-gray-300"
                            placeholder="Descripción" value={descripcion} onChange={(e) => setDescripcion(e.target.value)} />
                        <button className="text-blue-400 hover:text-blue-800 focus py-1 hover:bg-gray-50" onClick={() => editObjective()}><i className="far fa-save fa-lg"></i>Guardar</button>
                        ...
                        : (<>
                            ...
                            <button className="text-blue-400 hover:text-blue-800  py-1 hover:bg-gray-50 focus" onClick={() => setEditRow(true)} ><i className="fas fa-edit fa-lg"></i>Editar</button>
        ...
        ref={form}>
                    ...
                    <div className="bg-white  w-full py-2 px-4 align-center rounded-2xl my-1 flex flex-row gap-2 border-solid border-2 border-gray-300">
                        ...
                        <div className="w-full h-full flex flex-col ">
                            <div className=" py-2 px-8 flex flex-row ">
                                <span className="text-gray-600 text text-lg font-medium mt-4">
                                    Titulo Proyecto:
                                ...
                                <div className="w-full py-2 px-8 flex flex-row  justify-between gap-8 text-lg">
                                    <div className="h-full flex flex-row mt-2 ">
                                     ...
                                     bg-white border-2 border-gray-300">
                                            <SelectDate className="z-30" name="fechaInicio"
                                    ...
                                    <div className="h-full flex flex-row align-middle">
                                     ...
                                     bg-white border-2 border-gray-300">
                                            <SelectDate className="z-30"name="fechaFin"
                                    ...
                                    <input type="number" name="presupuesto"className="h-10 w-3/5 mx-5 px-10  rounded-xl z-0 focus:outline-none
                                     bg-white border-2 border-gray-300"
                ...
                hover:text-white  focus:border-4 "onClick={() => setAddObjective(!addObjective)}>Nuevo</button>}
                      ...
                      border-gray-400 border-2" defaultValue="GENERAL" defaultValue={newType} onChange={(e) => setnewType(e.target.value)}>
                                            ...
                                            <button className="text-blue-400 hover:text-blue-800 focus" onClick={() => AddNewObjective()}><i class="fas fa-folder-plus fa-lg"></i>Añadir</button>
                                            <button className="text-gray-400 hover:text-gray-700 ml-10" onClick={() => setAddObjective(false)}><i className="fas fa-ban fa-lg"></i>Cancelar</button>
                                        </div>
                                    </div>
                                </li>
...
<div className="flex flex-row gap-4  ">
    <button type="submit"   className="p-1 pl-4 pr-4  bg-transparent border-2 border-blue-500 font-bold text-blue-500 text-lg rounded-lg hover:bg-blue-600 
hover:text-white  
focus:border-4 " disabled={Object.keys(formData).length === 0}>Guardar</button>
