            ...
            <div className="w-full   overflow-y-hidden mt-6">
                ...
                hover:text-white  focus:border-4 "onClick={() => setAddObjective(!addObjective)}>Nuevo</button>}
                      ...
                      border-gray-400 border-2" defaultValue="GENERAL" defaultValue={newType} onChange={(e) => setnewType(e.target.value)}>
                                                ...
                                                <button className="text-blue-600 hover:text-blue-800 focus" onClick={() => AddNewObjective()}><i class="fas fa-folder-plus fa-lg"></i>Añadir</button>
                        ...
                        <div className=" w-full bg-white  mt-4 mb-10 flex flex-col align-center justify-center border-solid border-2 border-gray-300 rounded-xl py-2">
                            ...
                            <div className="flex flex-row justify-start"><div>
                                ...
                                <input disabled type="text" name="estado" className="h-10  ml-10 px-10  rounded-xl z-0 focus:outline-none
                                    ...
                                    <input disabled type="text" name="estado" className="h-10  ml-10 px-5  rounded-xl z-0 focus:outline-none
                            ...
                            <div className="w-full py-2 px-10 flex flex-row justify-around">
                                ...
                                <div className="flex flex-row gap-4  ">
                                    <button type="submit" className="p-1 pl-4 pr-4  bg-transparent border-2 border-blue-500 font-bold text-blue-500 text-lg rounded-lg hover:bg-blue-600 hover:text-white  focus:border-4 " disabled={Object.keys(formData).length === 0}>Guardar</button>
